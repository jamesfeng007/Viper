...
global g_ph
g_ph=PrintHelper('export_fbx.log')
...
def save(operator, context,
    ...
    if batch_mode == 'OFF':
        ...
        g_ph.printLog('operator type is: ' + type(operator).__name__ + PrintHelper.NL)
        g_ph.printLog('context.scene type is: ' + type(context.scene).__name__ + PrintHelper.NL)
        g_ph.printLog('filepath: ' + filepath + PrintHelper.NL)
        g_ph.printLogDict(**kwargs_mod)
