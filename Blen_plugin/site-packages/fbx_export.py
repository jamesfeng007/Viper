...
class FBXExport(object):
    def __init__(self, val):
        ...
        lib.Foo_AddMeshEdge.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_int]
        lib.Foo_AddMeshEdge.restype = ctypes.c_void_p        
        
        lib.Foo_AddMatIndex.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int]
        lib.Foo_AddMatIndex.restype = ctypes.c_void_p
        
        lib.Foo_AddTangent.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(Vector3)]
        lib.Foo_AddTangent.restype = ctypes.c_void_p
        
        lib.Foo_AddBinormal.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(Vector3)]
        lib.Foo_AddBinormal.restype = ctypes.c_void_p
        
        lib.Foo_SetTangentName.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p]
        lib.Foo_SetTangentName.restype = ctypes.c_void_p
        
        lib.Foo_SetBinormalName.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p]
        lib.Foo_SetBinormalName.restype = ctypes.c_void_p        
        ...
        lib.Foo_AddMaterial.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(Vector3), ctypes.POINTER(Vector3), ctypes.POINTER(Vector3)]
        lib.Foo_AddMaterial.restype = ctypes.c_void_p
        
        lib.Foo_AddTexture.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_bool, ctypes.c_int, ctypes.c_char_p, 
                                       ctypes.c_int, ctypes.c_int, ctypes.POINTER(Vector3), ctypes.POINTER(Vector3), ctypes.c_bool, ctypes.c_bool]
        lib.Foo_AddTexture.restype = ctypes.c_void_p
        
        lib.Foo_SetTextureMatProp.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
        lib.Foo_SetTextureMatProp.restype = ctypes.c_void_p        
        
        lib.Foo_AddPoseNode.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(Mat4x4)]
        lib.Foo_AddPoseNode.restype = ctypes.c_void_p
        ...
        lib.Foo_SetChannelDefaultValue.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_double]
        lib.Foo_SetChannelDefaultValue.restype = ctypes.c_void_p
        
        lib.Foo_AddChannelKey.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_float, ctypes.c_float]
        lib.Foo_AddChannelKey.restype = ctypes.c_void_p
        
        lib.Foo_SetTimeSpan.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float]
        lib.Foo_SetTimeSpan.restype = ctypes.c_void_p
        
        lib.Foo_SetFPS.argtypes = [ctypes.c_void_p, ctypes.c_float]
        lib.Foo_SetFPS.restype = ctypes.c_void_p        
        ...
        lib.Foo_PrintTakes.argtypes = [ctypes.c_void_p]
        lib.Foo_PrintTakes.restype = ctypes.c_void_p
        
        lib.Foo_SetAsASCII.argtypes = [ctypes.c_void_p, ctypes.c_bool]
        lib.Foo_SetAsASCII.restype = ctypes.c_void_p        
    ...
    def add_mesh_edge(self, name, sindex, eindex):
        lib.Foo_AddMeshEdge(self.obj, name, sindex, eindex)        
        
    def add_mat_index(self, name, index):
        lib.Foo_AddMatIndex(self.obj, name, index)
        
    def add_tangent(self, name, tan):
        lib.Foo_AddTangent(self.obj, name, tan)
        
    def add_binormal(self, name, bino):
        lib.Foo_AddBinormal(self.obj, name, bino)
        
    def set_binormal_name(self, name, bino):
        lib.Foo_SetBinormalName(self.obj, name, bino)
        
    def set_tangent_name(self, name, tan):
        lib.Foo_SetTangentName(self.obj, name, tan)
    ...
    def add_material(self, mname, sname, diffuse, ambient, emissive):
        lib.Foo_AddMaterial(self.obj, mname, sname, diffuse, ambient, emissive)
    ...
    def add_texture(self, name, fileName, relFileName, alphaSource, premultiplyAlpha, currentMappingType, UVSet, 
        ...
        lib.Foo_AddTexture(self.obj, name, fileName, relFileName, alphaSource, premultiplyAlpha, currentMappingType, UVSet, 
                           wrapModeU, wrapModeV, translation, scaling, useMaterial, useMipMap)
        
    def set_texture_mat_prop(self, name, matName, matProp):
        lib.Foo_SetTextureMatProp(self.obj, name, matName, matProp)        
        
    def add_pose_node(self, name, mat):
        lib.Foo_AddPoseNode(self.obj, name, mat)
    ...
    def set_channel_default_value(self, tname, mname, type, value):
        lib.Foo_SetChannelDefaultValue(self.obj, tname, mname, type, value)
        
    def add_channel_key(self, tname, mname, type, frame, value):
        lib.Foo_AddChannelKey(self.obj, tname, mname, type, frame, value)
        
    def set_time_span(self, tname, lstart, lend, rstart, rend):
        lib.Foo_SetTimeSpan(self.obj, tname, lstart, lend, rstart, rend)
        
    def set_fps(self, fps):
        lib.Foo_SetFPS(self.obj, fps)        
    ...
    def print_takes(self):
        lib.Foo_PrintTakes(self.obj)
        
    def set_as_ascii(self, asAscii):
        lib.Foo_SetAsASCII(self.obj, asAscii)        
