...
class FBXImport(object):
    def __init__(self):
        ...
        lib.Importer_GetMaterialProps.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.POINTER(Vector3), ctypes.POINTER(Vector3), ctypes.POINTER(Vector3)]
    ...
    def get_material_props(self, index, emissive, ambient, diffuse):
        return lib.Importer_GetMaterialProps(self.obj, index, emissive, ambient, diffuse)
