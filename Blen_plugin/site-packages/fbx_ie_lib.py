...
class FBXImport(object):
    def __init__(self):
        ...
        lib.Importer_GetMeshObjectTransformProp.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.POINTER(ObjectTransformProp)]
        lib.Importer_GetMeshObjectTransformProp.restype = ctypes.c_bool        
    ...
    def get_mesh_object_transform_prop(self, index, prop):
        lib.Importer_GetMeshObjectTransformProp(self.obj, index, prop)        
    ...
    def get_mesh_normal(self, index, normal, normal_size, layerInfo):
        return lib.Importer_GetMeshNormals(self.obj, index, normal, normal_size, layerInfo)    
